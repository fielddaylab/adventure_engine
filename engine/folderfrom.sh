...
# converts an fqid into its parent directory url
...
elif [ "@"$1 == "@person" ] || [ "@"$1 == "@speak" ] || [ "@"$1 == "@option" ]; then
...
elif [ "@"$1 == "@scene" ];       then echo ../assets/data/levels/$LEVEL/scenes;
elif [ "@"$1 == "@room" ];        then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms;
elif [ "@"$1 == "@cutscene" ];    then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/cutscenes;
elif [ "@"$1 == "@person" ];      then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/persons;
elif [ "@"$1 == "@speak" ];       then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/persons/$PERSON/speaks;
elif [ "@"$1 == "@option" ];      then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/persons/$PERSON/speaks/$SPEAK/options;
elif [ "@"$1 == "@object" ];      then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/objects;
elif [ "@"$1 == "@view" ];        then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/objects/$OBJECT/views;
elif [ "@"$1 == "@zone" ];        then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/objects/$OBJECT/views/$VIEW/zones;
elif [ "@"$1 == "@observation" ]; then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/observations;
elif [ "@"$1 == "@porthole" ];    then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/portholes;
elif [ "@"$1 == "@wildcard" ];    then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/wildcards;
elif [ "@"$1 == "@inert" ];       then echo ../assets/data/levels/$LEVEL/scenes/$SCENE/rooms/$ROOM/inerts;
fi
